...
uint8_t animation[ANIMATION_FRAMES][MSG_OUT_COUNT][MSG_OUT_BYTES] = {
  {
    { 0x08, 0x10, 0x20, 0x08, 0x00, 0x04, 0x40, 0x00, 0x00},
    { 0x18, 0x02, 0x80, 0x00, 0x08, 0x10, 0x00, 0x00, 0x80},
    { 0x20, 0x40, 0xDA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0xA0, 0xFF, 0x0F, 0x00, 0x04, 0x40, 0x00, 0x00},
    { 0x58, 0x00, 0x10, 0x00, 0x08, 0x10, 0x00, 0x00, 0x80},
    { 0x20, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x40, 0x00, 0xFA, 0x3F, 0x00, 0x01, 0x00, 0x00},
    { 0x19, 0x00, 0x02, 0x08, 0x01, 0x08, 0x00, 0x01, 0x80},
    { 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x00, 0x00, 0x02, 0xC2, 0xFF, 0x17, 0x00, 0x00},
    { 0x19, 0x40, 0x00, 0x01, 0x01, 0x08, 0x00, 0x01, 0x80},
    { 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0xC0, 0x0F, 0x08, 0x00, 0x20, 0x00, 0xEC, 0x01, 0x00},
    { 0x1B, 0x08, 0x20, 0x40, 0x00, 0x04, 0x80, 0x00, 0x80},
    { 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x37, 0x00, 0x08, 0x00, 0x20, 0x00, 0x04, 0x00, 0x00},
    { 0x1E, 0x01, 0x04, 0x40, 0x00, 0x04, 0x80, 0x00, 0x80},
    { 0x00, 0x04, 0x00, 0x00, 0x80, 0x03, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x00, 0x10, 0x00, 0x08, 0x10, 0x00, 0x01, 0x00},
    { 0xB8, 0x00, 0x08, 0x00, 0x10, 0x00, 0x41, 0x00, 0x80},
    { 0x00, 0x10, 0x00, 0xC0, 0x6D, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x00, 0x10, 0x00, 0x08, 0x10, 0x00, 0x01, 0x00},
    { 0x18, 0x04, 0x40, 0x00, 0x10, 0x00, 0x41, 0x00, 0x80},
    { 0x00, 0x10, 0x00, 0x30, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x00, 0x02, 0x20, 0x00, 0x02, 0x20, 0x00, 0x00},
    { 0x18, 0x20, 0x00, 0xC2, 0xFF, 0x03, 0x02, 0x00, 0x80},
    { 0x40, 0x82, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x00, 0x02, 0x20, 0x00, 0x02, 0x20, 0x00, 0x00},
    { 0x18, 0x00, 0x01, 0x10, 0x80, 0xFC, 0x1F, 0x00, 0x80},
    { 0x40, 0x80, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x80, 0x00, 0x10, 0x00, 0x01, 0x08, 0x00, 0x00},
    { 0x18, 0x80, 0x00, 0x20, 0x00, 0x01, 0xE4, 0x01, 0x80},
    { 0xFF, 0x00, 0x05, 0x01, 0x00, 0x00, 0x00, 0x00, 0x40}
  },
  {
    { 0x00, 0x80, 0x00, 0x10, 0x00, 0x01, 0x08, 0x00, 0x00},
    { 0x18, 0x10, 0x00, 0x04, 0x00, 0x01, 0x04, 0x00, 0x80},
    { 0x80, 0xFD, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}
  }
};
